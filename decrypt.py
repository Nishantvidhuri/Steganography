...
def decrypt():
    ...
    img_label = Label(app, image=render)
    img_label.pack(pady=70)

    img_label = Label(app, text="The image", fg='black' ,bg='green', font=("Forte", 15))
    img_label.place(x=250, y=320)

    img_label = Label(app, text="The message", fg='black' ,bg='green', font=("Forte", 15))
    img_label.place(x=230, y=540)
    ...
    message_label = Label(app, text=message, bg='lavender', font=("Forte", 30))
    message_label.place(x=100, y=450)
...
main_button = Button(app, text="Start Program", font=("Forte", 10), bg='white', fg='black', command=decrypt)
